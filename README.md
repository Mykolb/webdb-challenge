...
RDBMS: is type of management system where data is stored in table format like a spreadsheet 

SQL: standard language used to manage db's & data within them, way to interact with DBMS

1. Why do tables need a `primary key`?

PK identifies each row in a table so tables can have unique id 
